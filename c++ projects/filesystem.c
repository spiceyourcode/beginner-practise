...
// displaying the help propmt

void displayHelp() {
    printf("Usage: ./filesystem <command> [arguments]\n");
    printf("Commands:\n");
    printf("  createfs <numBlocks>         Create a file system with specified number of blocks\n");
    printf("  savefs <fileName>            Save the current file system to a file\n");
    printf("  openfs <fileName>            Open a file system from a file\n");
    printf("  ls                           List all files in the file system\n");
    printf("  rm <fileName>                Remove a file from the file system\n");
    printf("  mv <oldName> <newName>       Rename a file in the file system\n");
    printf("  put <externalFileName>       Store an external file in the file system\n");
    printf("  get <fileName>               Retrieve a file from the file system\n");
    printf("  setuser <fileName> <userName> Set the user name for a file\n");
    printf("  link <fileName> <linkName>   Create a link to a file\n");
    printf("  unlink <linkName>            Remove a link to a file\n");
